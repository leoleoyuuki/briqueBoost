      ...
      <DialogContent className="sm:max-w-[425px] bg-slate-900 border-slate-800">
        <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
                ...
                <Button type="submit" disabled={isLoading} className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl transition-all duration-200 font-medium text-sm h-auto">
